...
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Identifier'), 'entity');
INSERT INTO "Identifier" DEFAULT VALUES;
...
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Category" ("id", "name", "kind") VALUES (lastval(), 'Division', 'registry');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Division'), 'name');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Division'), 'parent');
INSERT INTO "Identifier" DEFAULT VALUES;
...
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Role'), 'Division');
INSERT INTO "Identifier" DEFAULT VALUES;
...
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Account'), 'fullName');
INSERT INTO "Identifier" DEFAULT VALUES;
...
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Category" ("id", "name", "kind") VALUES (lastval(), 'Area', 'entity');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Area'), 'name');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Area'), 'owner');
INSERT INTO "Identifier" DEFAULT VALUES;
...
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Category" ("id", "name", "kind") VALUES (lastval(), 'Chat', 'entity');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Chat'), 'createdBy');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Chat'), 'name');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Category" ("id", "name", "kind") VALUES (lastval(), 'ChatMember', 'entity');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'ChatMember'), 'account');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'ChatMember'), 'chat');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'ChatMember'), 'status');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Category" ("id", "name", "kind") VALUES (lastval(), 'Entity', 'registry');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Entity'), 'name');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Entity'), 'kind');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Category" ("id", "name", "kind") VALUES (lastval(), 'Field', 'registry');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Field'), 'entity');
INSERT INTO "Identifier" DEFAULT VALUES;
...
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Category" ("id", "name", "kind") VALUES (lastval(), 'Folder', 'entity');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Folder'), 'parent');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Folder'), 'owner');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Folder'), 'name');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Folder'), 'logo');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Category" ("id", "name", "kind") VALUES (lastval(), 'Message', 'entity');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Message'), 'thread');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Message'), 'chat');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Message'), 'area');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Message'), 'from');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'Message'), 'data');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Category" ("id", "name", "kind") VALUES (lastval(), 'MessageReaction', 'entity');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'MessageReaction'), 'message');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'MessageReaction'), 'reaction');
INSERT INTO "Identifier" DEFAULT VALUES;
INSERT INTO "Field" ("id", "categoryId", "name") VALUES (lastval(), (SELECT "id" FROM "Category" WHERE "name" = 'MessageReaction'), 'from');
INSERT INTO "Identifier" DEFAULT VALUES;
...
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Identifier') AND "name" = 'entity');
...
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Category') WHERE "id" = (SELECT "id" FROM "Category" WHERE "name" = 'Division');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Division') AND "name" = 'name');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Division') AND "name" = 'parent');
...
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Role') AND "name" = 'Division');
...
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Account') AND "name" = 'fullName');
...
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Category') WHERE "id" = (SELECT "id" FROM "Category" WHERE "name" = 'Area');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Area') AND "name" = 'name');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Area') AND "name" = 'owner');
...
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Category') WHERE "id" = (SELECT "id" FROM "Category" WHERE "name" = 'Chat');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Chat') AND "name" = 'createdBy');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Chat') AND "name" = 'name');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Category') WHERE "id" = (SELECT "id" FROM "Category" WHERE "name" = 'ChatMember');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'ChatMember') AND "name" = 'account');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'ChatMember') AND "name" = 'chat');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'ChatMember') AND "name" = 'status');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Category') WHERE "id" = (SELECT "id" FROM "Category" WHERE "name" = 'Entity');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Entity') AND "name" = 'name');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Entity') AND "name" = 'kind');
...
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') AND "name" = 'entity');
...
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Folder') AND "name" = 'owner');
...
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Folder') AND "name" = 'logo');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Category') WHERE "id" = (SELECT "id" FROM "Category" WHERE "name" = 'Message');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Message') AND "name" = 'thread');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Message') AND "name" = 'chat');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Message') AND "name" = 'area');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Message') AND "name" = 'from');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Message') AND "name" = 'data');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Category') WHERE "id" = (SELECT "id" FROM "Category" WHERE "name" = 'MessageReaction');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'MessageReaction') AND "name" = 'message');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'MessageReaction') AND "name" = 'reaction');
UPDATE "Identifier" SET "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'Field') WHERE "id" = (SELECT "id" FROM "Field" WHERE "categoryId" = (SELECT "id" FROM "Category" WHERE "name" = 'MessageReaction') AND "name" = 'from');
